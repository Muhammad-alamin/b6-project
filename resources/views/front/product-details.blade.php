                ...
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    ...
                    <div class="rating d-flex">
                        <p class="text-left mr-4">
                            <a href="#" class="mr-2">{{$product->category->name}}</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="{{route('front.product.details', $product->id)}}" class="img-prod"><img class="img-fluid" src="{{file_exists($product->image)?asset($product->image):asset('assets/front/images/No-image-available.png')}}" alt="Colorlib Template">
