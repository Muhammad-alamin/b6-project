                    ...
                    <div class="col-md-12 ftco-animate">
                        <div class="cart-list">
                            <table class="table">
                                ...
                                <tr class="text-center">
                                    <td class="product-remove" onclick="return confirm('Are you Confirm to remove this item form cart ?')"><a href="{{route('remove.to.cart',$product_id)}}"><span class="ion-ios-close"></span></a></td>

                                    <td class="image-prod"><div class="img" style="background-image:url({{file_exists($cart['image'])? $cart ['image']:asset('assets/front/images/No-image-available.png')}});"></div></td>
