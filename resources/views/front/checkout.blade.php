...
@section('content')
    ...
    <div class="hero-wrap hero-bread" style="background-image: url({{asset('assets/front/images/bg_1.jpg')}});">
        ...
        <section class="ftco-section">
            <div class="container">
                <form action="{{route('front.place.order')}}" class="billing-form" method="post">
                    @csrf
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="postcode" value="{{old('postcode')}}" type="text" class="form-control" placeholder="">
                                @error('postcode')<i class="text-danger">{{$message}}</i>@enderror
                            </div>
                        </div>
                        <div class="w-100"></div>
                        <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="cart-detail p-3 p-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="radio">
                                                    <label><input type="radio" value="card" name="payment_method" class="mr-2" @if (old('payment_method') == 'card') checked @endif> Card </label>
                                                </div>
                                            </div>
