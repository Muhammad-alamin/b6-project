...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="{{ route('login') }}" class="h1"><b></b>Login</a>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="input-group mb-3">
                    ...
                    @error('password')<i class="text-danger">{{$mesage}}</i>@enderror
                </div>
                <div class="row">
                    <div class="col-8">
            ...
            <p class="mb-0">
                <a href="{{route('customers.create')}}" class="text-center">Register a new member</a>
            </p>
        </div>
        <!-- /.card-body -->
    </div>
